...
<?php 
    ...
    while($b=mysqli_fetch_array($query)){
        ...
        <tr>
            ...
            <td>
                <a href="?view=ubahberobat&id=<?php echo $b['notransaksi']; ?>"><button class="btn">Edit</button></a>
                <a href="?view=hapusberobat&id=<?php echo $b['notransaksi']; ?>"><button class="btn">Hapus</button></a>
            </td>
