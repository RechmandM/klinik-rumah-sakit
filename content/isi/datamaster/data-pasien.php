                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                                        ...
                                        <div class="modal-body">
                                            <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p>
                                                        <input id="laki" name="jenkel" type="radio" value="Laki-Laki">
                                                        <label for="laki">Laki-Laki</label>
                                                        <input id="perempuan" name="jenkel" type="radio" value="Perempuan">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="?view=ubahpasien&id=<?php echo $b['pasienid']; ?>"><button class="btn">Edit</button></a>
                                        <a href="?view=hapuspasien&id=<?php echo $b['pasienid']; ?>"><button class="btn">Hapus</button></a>
                                    </td>
