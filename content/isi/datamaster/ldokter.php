        ...
        ?>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nmdokter" type="text" class="form-control" placeholder="Nama Pasien ....">
                    </div><p>    
                    <div class="form-group">
                        <label>Poliid</label>
...
<?php 
    ...
    while($b=mysqli_fetch_array($query)){
        ...
        <tr>
            ...
            <!-- <td>
                <a href="?view=ubahpasien&pasienid=<?php echo $b['dokterid']; ?>"><button class="btn">Edit</button></a>
                <a href="?view=hapuspasien&pasienid=<?php echo $b['dokterid']; ?>"><button class="btn">Hapus</button></a>
            </td>
         -->
        <?php } ?>
</table>
